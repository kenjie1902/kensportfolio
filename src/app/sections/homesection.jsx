  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gray-900">
      ...
      <div className="container mx-auto px-6 py-24 z-10 relative">
        ...
        >
          {[
            { icon: <FiGithub size={24} />, color: 'hover:text-gray-300' },
            { icon: <FiLinkedin size={24} />, color: 'hover:text-blue-400' },
            { icon: <FiTwitter size={24} />, color: 'hover:text-blue-400' },
            { icon: <FiMail size={24} />, color: 'hover:text-red-400' },
            { icon: <FiFacebook size={24} />, color: 'hover:text-blue-500' },
          ].map((item, index) => (
            <motion.a
              key={index}
              whileHover={{ y: -3 }}
